<template>
    ...
    <div class="company-name-wrapped">
        ...
        <div class="company-name-content">
            <el-input v-model="companyName" style="width: 240px" placeholder="公司名称" />
        </div>
        <el-button type="primary" @click="ChangeCompanyName" :disabled="!companyNameFlag">修改公司名称</el-button>
    </div>
    <!-- 公司介绍 -->
    <div class="company-name-wrapped">
        <span class="span">公司介绍</span>
        <el-button type="success" @click="bus.emit('sendValueId', 8)">编辑公司介绍</el-button>
    </div>
    <!-- 公司架构 -->
    <div class="company-name-wrapped">
        <span class="span">公司架构</span>
        <el-button type="success" @click="bus.emit('sendValueId', 9)">编辑公司架构</el-button>
    </div>
    <!-- 公司战略 -->
    <div class="company-name-wrapped">
        <span class="span">公司战略</span>
        <el-button type="success" @click="bus.emit('sendValueId', 10)">编辑公司战略</el-button>
    </div>
    <!-- 现任高层 -->
    <div class="company-name-wrapped">
        <span class="span">现任高层</span>
        <el-button type="success" @click="bus.emit('sendValueId', 11)">编辑现任高层</el-button>
    </div>
